        ...
        for i in os.listdir(image_path):
            ...
            if os.path.isdir(image_path_dir):
                ...
                if "不动产登记申请书" == i:
                    ...
                    #tab_img.ele("tag=li@|text():委托函@|text():授权委托书").ele("tag=div@@class:el-upload--text").click.to_upload(file_list)
                    up_img_onebyone(file_list,tab_img.ele("tag=li@|text():委托函@|text():授权委托书").ele("tag=div@@class:el-upload--text"))
                elif "商品房预售合同"==i:
